\begin{abstract}
 ...
 transfer issues especially for low-latency real-time systems, but not
 much is studied yet in the literature.
 In this paper, we investigate currently-achievable data transfer
 methods with the state of the art GPU technology.
