...
\begin{figure}[!t]
 \centering
 \subfigure[Host to Device]{\includegraphics[width=0.42\textwidth]{figure/Graph/forIntro_HtoD.pdf}}\\
 \subfigure[Device to Host]{\includegraphics[width=0.42\textwidth]{figure/Graph/forIntro_DtoH.pdf}}
